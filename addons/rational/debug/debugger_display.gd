...
const DebugGraphNode := preload("debugger_graph_node.gd")

const TREE_ICON: Texture2D = preload("../icons/RationalTree.svg")

#var tree_icon: Texture2D = Util.comp_get_icon("")
